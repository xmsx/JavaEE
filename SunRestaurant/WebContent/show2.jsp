						...
						<TABLE cellSpacing=1 cellPadding=1 width="100%" align=center
							...
							<TBODY>
								...
								<tr>
									...
									<td  >
										<div align="right">
											<a name="btnTopPage"  id="btnTopPage" href="loginControl?actiontype=pagelist&pageNO=1" title="首页">|&lt;&lt; </a>&nbsp;
											<a name="btnPreviousPage"  id="btnPreviousPage" href="loginControl?actiontype=pagelist&pageNO=${requestScope.pageModel.prevPageNO}" title="上页"> &lt;  </a>&nbsp;
											<a name="btnNextPage"  id="btnNextPage" href="loginControl?actiontype=pagelist&pageNO=${requestScope.pageModel.nextPageNO}" title="下页">  &gt; </a>&nbsp;
											<a name="btnBottomPage"  id="btnBottomPage" href="loginControl?actiontype=pagelist&pageNO=${requestScope.pageModel.bottomPageNO}" title="尾页"> &gt;&gt;|</a>
