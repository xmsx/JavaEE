								...
								<TR>
									...
									<TD align=middle>
										<FONT style="FONT-SIZE: 13px; COLOR: #000000">&nbsp;|&nbsp;</FONT><A
											...
											href="#" target=_self><FONT
											style="FONT-SIZE: 13px; COLOR: #000000">客服中心</FONT>
						...
						<table width="90%" border="0" align="center" cellpadding="0"
							...
							<tr>
								<td width="90" height="90" valign="top">
									<img src="${sessionScope.currentdish.img}" border="0" width="80" height="80">
								</td>
								<td valign="top">
									<table width="98%" border="0" cellspacing="1" cellpadding="0"
										...
										<tr>
											<td>
												<strong>${sessionScope.currentdish.name}</strong>
											</td>
										</tr>
										<tr>
											<td height="21">
												...
												<strike>人民币0元</strike>
												<br>
												<font color="#ff0000">现价：人民币${sessionScope.currentdish.price }元</font>
												<br>
												美味可口！
											</td>
										</tr>
									...
									<table width="145" border="0" cellspacing="1" cellpadding="0">
										<tr>
											<td align="center" width="70">
												<a href=#
													onClick="window.open('addtocart?dishid=${sessionScope.currentdish.dishid}','shopcart','width=580,height=250,resizable=no,scrollbars=yes')">
													<img src="images/buy_cn.gif" border=0 width="60"
														height="20">
												</a>
											</td>
										</tr>
